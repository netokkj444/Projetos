...
import BankProject.Entites.InformationBank;
...
public class Bank {
    public static void main(String[] args) throws ParseException {
        ...
        Date now = new Date();
        List<InformationBank> list = new ArrayList<>();
        ...
        System.out.println("Welcome to BankProject.ProjetoBanco of Holy Mary!");
        ...
        if (confirmAccount.equals("Y")) {
            ...
            System.out.print("Are you Bussines or normal people? (b/p) ");
            char peopleorBussines = sc.next().charAt(0);
            if (peopleorBussines == 'b' || peopleorBussines == 'B') {
                System.out.print("Name of Bussines: ");
                String nameBussines = sc.next();
                System.out.print("Type the EIN: ");
                int idEIN = sc.nextInt();
                System.out.print("");
            } else {
                System.out.println("Let's start your registration!");
                do {
                ...
                if (confirmInvest.equals("Y")) {
                    ...
                    switch (invest) {
                        case 1:
                            ...
                            InformationBank showinvestPoup = new InformationBank(valueofInvestSavings, timeofInvest);
                        ...
                        case 2:
                            ...
                            InformationBank showinvestTreasure = new InformationBank(valueofInvestTrea);
                        ...
                        case 3:
                            ...
                            InformationBank selic = new InformationBank(valueSelic);
                ...
                list.add(new InformationBank(deposit, withdraw));
                ...
                System.out.println("Your registration has been completed!   Thank you for your preference!");
            }
        } else {
            System.out.println("What a shame you didn't want to join us, come back soon!");
        }
        sc.close();
    }
}
